            ...
            <div class="quick-menu-grid">
                ...
                <button class="quick-menu-btn role-quick-menu" id="cashierBtn" style="display: flex;">
                    <div class="quick-menu-icon" style="background: linear-gradient(135deg, #991B27 0%, #BD2630 100%);">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="white">
                            <g fill="white">
                                <path d="M4 19v2a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-2z"/>
                                <path fill-rule="evenodd" d="M9 3a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-2v1h2a1 1 0 0 1 .994.89l.901 8.11H4.105l.901-8.11A1 1 0 0 1 6 8h6V7h-2a1 1 0 0 1-1-1zm1.01 8H8v2.01h2.01zm.99 0h2.01v2.01H11zm5.01 0H14v2.01h2.01zM8 14h2.01v2.01H8zm5.01 0H11v2.01h2.01zm.99 0h2.01v2.01H14zM11 4h6v1h-6z" clip-rule="evenodd"/>
                            </g>
                        </svg>
                    </div>
                    <span>Kasir</span>
                ...
                <button class="quick-menu-btn role-quick-menu" id="recordBtn" style="display: none;">
                    <div class="quick-menu-icon" style="background: linear-gradient(135deg, #4CAF50 0%, #66BB6A 100%);">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 256 256" fill="white">
                            <path fill="white" d="M88 96a8 8 0 0 1 8-8h64a8 8 0 0 1 0 16H96a8 8 0 0 1-8-8m8 40h64a8 8 0 0 0 0-16H96a8 8 0 0 0 0 16m32 16H96a8 8 0 0 0 0 16h32a8 8 0 0 0 0-16m96-104v108.69a15.86 15.86 0 0 1-4.69 11.31L168 219.31a15.86 15.86 0 0 1-11.31 4.69H48a16 16 0 0 1-16-16V48a16 16 0 0 1 16-16h160a16 16 0 0 1 16 16M48 208h104v-48a8 8 0 0 1 8-8h48V48H48Zm120-40v28.7l28.69-28.7Z"/>
                        </svg>
                    </div>
