    ...
    <div class="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-500 to-blue-700">
        <div class="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
            ...
            <form id="registerForm" class="space-y-4">
                ...
                <div>
                    <label for="confirmPassword" class="block text-gray-700 font-semibold mb-2">Konfirmasi Password</label>
                    <input
                        type="password"
                        id="confirmPassword"
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-600">Sudah punya akun? <a href="/login" class="text-blue-500 hover:text-blue-700 font-semibold">Login di sini</a></p>
            </div>
        </div>
    </div>
</body>
